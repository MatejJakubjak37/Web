...
<div class="container container-xl-custom pt-5 pb-3">
    <div class="row">
        <div class="col-lg-6 mb-5">
            ...
            <h4 class="font-weight-bold mt-4">Klampiarske práce</h4>
            <ul class="list list-icons list-primary font-weight-medium mt-3">
                <li><i class="fas fa-check text-color-primary"></i>Výroba a inštalácia všetkých druhov klampiarskych prvkov z pozinku, farbeného pozinku, medi, hliníka a RHEINZINKu.</li>
                <li><i class="fas fa-check text-color-primary"></i>Montáž žľabov a zvodov, oplechovanie komínov.</li>
                <li><i class="fas fa-check text-color-primary"></i>Záveterné lišty, bočné lemovania.</li>
                <li><i class="fas fa-check text-color-primary"></i>Rímsy a atiky, parapety, okapové plechy a úžľabia.</li>
            </ul>
        </div>
        <div class="col-lg-6 mb-5">
            <span class="thumb-info thumb-info-swap-content anim-hover-inner-wrapper rounded">
            ...
            <h4 class="font-weight-bold mt-4">Pokrývačské práce</h4>
            <ul class="list list-icons list-primary font-weight-medium mt-3">
                <li><i class="fas fa-check text-color-primary"></i>Dodávka kompletných strešných systémov vrátane latovania.</li>
                <li><i class="fas fa-check text-color-primary"></i>Ťažké krytiny ako BRAMAC, MEDITERRAN, TONDACH a KM-BETA. Ľahké krytiny ako LINDAB, KJG, MASLEN.</li>
                <li><i class="fas fa-check text-color-primary"></i>Asfaltové šindle IKO a strešné okná VELUX a FAKRO.</li>
                <li><i class="fas fa-check text-color-primary"></i>Odkvapové systémy KJG a ELEMENT.</li>
            </ul>
        </div>
        <div class="col-lg-6 mb-5">
            <span class="thumb-info thumb-info-swap-content anim-hover-inner-wrapper rounded">
            ...
            <h4 class="font-weight-bold mt-4">Údržba pred zimou a demontáž</h4>
            <ul class="list list-icons list-primary font-weight-medium mt-3">
                <li><i class="fas fa-check text-color-primary"></i>Zabezpečujeme údržbu, vyčistenie a kontrolu strechy a žľabov pred zimou.</li>
                <li><i class="fas fa-check text-color-primary"></i>V prípade potreby vykonávame tmelenie netesností a revízie.</li>
                <li><i class="fas fa-check text-color-primary"></i>Demontujeme pôvodnú krytinu, zabezpečujeme jej odvoz a ekologické zneškodnenie.</li>
                <li><i class="fas fa-check text-color-primary"></i>Poskytujeme kompletné latovanie, debnenie a ukončovacie oplechovanie strechy.</li>
            </ul>
        </div>
        <div class="col-lg-6 mb-5">
            <span class="thumb-info thumb-info-swap-content anim-hover-inner-wrapper rounded">
            ...
            <h4 class="font-weight-bold mt-4">Poradenstvo</h4>
            <ul class="list list-icons list-primary font-weight-medium mt-3">
                <li><i class="fas fa-check text-color-primary"></i>Sme pripravení poradiť a nájsť najvhodnejšiu alternatívu materiálov.</li>
                <li><i class="fas fa-check text-color-primary"></i>Pomôžeme vám vybrať optimálne konštrukčné riešenia.</li>
                <li><i class="fas fa-check text-color-primary"></i>Obhliadky a kalkulácie sú zadarmo.</li>
            </ul>
        </div>
    </div>
</div>
...
<section class="section my-0 py-5 border-0 bg-color-primary text-color-light p-relative mt-3 overflow-hidden">
    ...
    <svg class="d-none d-lg-block custom-svg-position-2 rotate-r-90" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 1686.88 1095.86" data-appear-animation-svg="true">
        <path class="appear-animation" data-plugin-options="{'accY': -500, 'forceAnimation': true}" data-appear-animation="customLines1anim" data-appear-animation-delay="100" data-appear-animation-duration="7s" fill="none" stroke="#9499a1" stroke-width="2px" stroke-miterlimit="10" d="M87.95,1.4c6.82,9.14,15.53,21.59,24.68,36.94c6.82,11.45,27.18,46.82,42.55,96.51
    ...
    <div class="container container-xl-custom py-4">
        <div class="row align-items-center py-5">
            <div class="col-lg-3 text-lg-end">
                <h2 class="text-color-dark font-weight-bold text-10 negative-ls-05 line-height-1 mb-0 appear-animation" data-appear-animation="fadeInUpShorterPlus" data-appear-animation-delay="100" data-plugin-options="{'minWindowWidth': 0}">Pre tých, čo dbajú o kvalitu a <br><span class="font-weight-extra-bold custom-highlight-1 custom-highlight-1-tertiary ws-nowrap p-1 custom-highlight-anim custom-highlight-anim-delay">dlhodobé riešenia</span></h2>
            </div>
            <div class="col-lg-6 mt-3 mt-lg-0">
                <p class="mb-0 text-color-dark ps-lg-5">Kvalitné klampiarske práce pre zdravý domov, zabezpečujeme spoľahlivú ochranu vášho domova od strechy až po žľaby.</p>
            </div>
            <div class="col-lg-3 mt-3 mt-lg-0 text-lg-end">
                <a href="{{route('contact')}}" class="btn btn-modern btn-light text-color-dark font-weight-bold border-0 py-3 px-5 btn-arrow-effect-1 ws-nowrap">Chcem cenovú ponuku<i class="fas fa-arrow-right ms-2"></i></a>
            </div>
        </div>
    </div>
</section>
