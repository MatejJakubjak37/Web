						...
						<div class="container-fluid position-relative z-index-3 h-100">
							<div class="row px-lg-5 mx-lg-3 justify-content-between align-items-center h-100">
								<div class="col-xl-5 text-center text-xl-end">
									...
									<a href="#" class="btn btn-arrow-effect-1 ws-nowrap text-light text-4 bg-transparent border-0 px-0 appear-animation" data-appear-animation="fadeInUpShorterPlus" data-appear-animation-delay="1300" data-plugin-options="{'minWindowWidth': 0}">Chcem cenovú ponuku<i class="fas fa-arrow-right ms-2 p-relative top-2"></i></a>
								</div>
						...
						<div class="row w-75 mx-auto justify-center py-5">
							<div class="col-lg-7">
								...
								<div class="hstack gap-4">
									<div>
										<a href="#" class="btn btn-modern btn-dark font-weight-bold border-0 py-3 px-5 btn-arrow-effect-1 ws-nowrap">NAŠE SLUŽBY <i class="fas fa-arrow-right ms-2"></i></a>
									</div>
									<div class="vr"></div>
									<div>
										<img src="img/demos/renewable-energy/logos/logo-1.png" class="img-fluid me-3">
										<img src="img/demos/renewable-energy/logos/logo-2.png" class="img-fluid">
									</div>
								</div>
							</div>
					...
					<div class="col-12 text-center">
						...
						<div class="col-sm-4 col-lg-2 mb-5 mb-lg-0">
							<a href="#" target="_blank">
								<img src="{{ asset('img/partners/images.png')}}" alt="logo" class="img-fluid" style="max-width: 150px;">
							</a>
						</div>
						<div class="col-sm-4 col-lg-2 mb-5 mb-lg-0">
							<a href="#" target="_blank">
								<img src="{{ asset('img/partners/IMG_2224.JPG')}}" alt="logo" class="img-fluid" style="max-width: 150px;">
							</a>
						</div>
						<div class="col-sm-4 col-lg-2 mb-5 mb-lg-0">
							<a href="#" target="_blank">
								<img src="{{ asset('img/partners/IMG_2225.JPG')}}" alt="logo" class="img-fluid" style="max-width: 150px;">
							</a>
						</div>
				</div>
